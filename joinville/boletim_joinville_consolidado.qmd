  ...
  pdf:
    ...
    include-in-header:
      text: |
        ...
        \pagestyle{fancy}
        \fancyhf{}
        \fancyhead[L]{\includegraphics[height=40pt]{~/Documents/intramunicipal/logo1.png}} #ajustar!!
        \fancyhead[R]{\includegraphics[height=40pt]{~/Documents/intramunicipal/logo2.png}} #ajustar!!
...
dados_api_dengue <- read.csv("~/Documents/dados_teste_intramunicipal/se05/dengue_52-5.csv") %>%
  mutate(arbo = "dengue") %>%
  arrange(SE)

## SUBSTITUIR AQUI POR DADOS da tabela_historico_alerta
dados_api_chikon <- read.csv("~/Documents/dados_teste_intramunicipal/se05/chikungunya_52-5.csv") %>%
  mutate(arbo = "chikon") %>%
  arrange(SE)
...
df_mun <- read_parquet("~/Documents/dados_teste_intramunicipal/se05/dengue.parquet") %>% 
