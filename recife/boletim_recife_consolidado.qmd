...
load("~/Documents/intramunicipal/recife/ref_RF.RData")
...
dados_api_dengue <- read.csv("~/Documents/dados_teste_intramunicipal/recife/se05/dengue_52-5.csv") %>% 
  mutate(arbo = "dengue") %>% 
  arrange(SE)

dados_api_chikon <- read.csv("~/Documents/dados_teste_intramunicipal/recife/se05/chikungunya_52-5.csv") %>% 
  mutate(arbo = "chikon") %>% 
  arrange(SE)
...
df_mun <- read_parquet("~/Documents/dados_teste_intramunicipal/recife/se05/dengue.parquet") %>% 
